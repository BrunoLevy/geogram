...
namespace {
     ...
     * @param filename
     */
    // TODO: add later // Mesh &voronoi_seeds, Delaunay_var &delaunay, ,
    ...
    int polyhedral_mesher(
        ...
        CVT.RVD()->set_exact_predicates(true);
        {
            ...
            CVT.RVD()->for_each_polyhedron(callback); // TODO add parallel support
        }
...
int main(int argc, char** argv) {
    ...
    try {
        ...
        save_RVD_cells_to_vtu(M_out, output_filename);
